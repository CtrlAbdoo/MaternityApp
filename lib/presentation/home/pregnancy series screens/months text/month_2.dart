...
class _Month2State extends State<Month2> {
  ...
  Future<void> fetchFirestoreData() async {
    ...
    for (var doc in imageSnapshot.docs) {
      ...
      final section = doc.id.trim().toLowerCase(); // ex: "1. Exercise :"
      if (url != null) {
    ...
    return sectionImages.values.every((list) => list.isEmpty) &&
      ...
      child: Column(
        ...
        children: [
          ...
          buildSubtitle("Videos"),
          ...buildLinks(sectionLinks['essential']),
