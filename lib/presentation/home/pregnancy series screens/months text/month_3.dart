  ...
  Future<void> fetchFirestoreData() async {
    ...
    for (var doc in textSnapshot.docs) {
      ...
      if (data.containsKey('text')) {
        firestoreTexts[doc.id.trim()] = data['text'] as String;
      } else {
        firestoreTexts[doc.id.trim()] = '';
      }
    }
