...
class Month6 extends StatefulWidget {
  const Month6({super.key});

  @override
  State<Month6> createState() => _Month6State();
}
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "In the sixth month of pregnancy, the mother should focus on maintaining energy levels with proper nutrition and safe exercise.",
