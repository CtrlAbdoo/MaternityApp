    ...
    try {
      ...
      for (var doc in imageSnapshot.docs) {
        ...
        if (url != null) {
          ...
          } else if (section.contains('essential vitamins and minerals') || section.contains('proteins')) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "In the eighth month of pregnancy, the mother should focus on preparing for delivery with light exercise and a nutrient-rich diet.",
          ...
          buildSection(
            ...
            links: [],
            subtitle: "Vitamin and Protein Images",
          ),
